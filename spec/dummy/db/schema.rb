...
ActiveRecord::Schema.define(version: 20140109223051) do
  ...
  create_table "spree_import_source_files", force: true do |t|
  ...
  create_table "spree_products", force: true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "sku_pattern"
    t.integer  "batch_id"
  end

  add_index "spree_products", ["available_on"], name: "index_spree_products_on_available_on"
  add_index "spree_products", ["batch_id"], name: "index_spree_products_on_batch_id"
  ...
  add_index "spree_variants", ["batch_id"], name: "index_spree_variants_on_batch_id"
  add_index "spree_variants", ["ls_id"], name: "index_spree_variants_on_ls_id"
