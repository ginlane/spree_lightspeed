...
ActiveRecord::Schema.define(version: 20131101012522) do
  ...
  create_table "spree_variants", force: true do |t|
    ...
    t.integer  "lightspeed_product_id"
  end

  add_index "spree_variants", ["lightspeed_product_id"], name: "index_spree_variants_on_lightspeed_product_id"
